...
pub(crate) fn write_varint_field(out: &mut Vec<u8>, field: u32, value: u64) {
...
pub(crate) fn write_fixed64_field(out: &mut Vec<u8>, field: u32, value: f64) {
...
pub(crate) fn write_string_field(out: &mut Vec<u8>, field: u32, value: &str) {
    write_len_field(out, field, value.as_bytes());
}

pub(crate) fn write_message_field(out: &mut Vec<u8>, field: u32, message: &[u8]) {
