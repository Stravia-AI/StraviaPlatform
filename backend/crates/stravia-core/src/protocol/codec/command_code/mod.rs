...
pub(crate) const DEFAULT_WORKING_DIR: &str = r"C:\Users\dev\projects\app";
...
impl ProtocolAdapter for CommandCodeGenerateV1 {
    ...
    fn stream_decoder(&self) -> Result<WireStreamDecoder, TransformError> {
        Ok(WireStreamDecoder::CommandCode(
...
inventory::submit! {
    EndpointRegistration { make: || Box::new(CommandCodeGenerateV1) }
}
