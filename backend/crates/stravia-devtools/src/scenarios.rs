...
pub const ANCHOR_BASIC_NONSTREAM: &str = "STRAVIA_PROBE_BASIC_NONSTREAM";
pub const ANCHOR_BASIC_STREAM: &str = "STRAVIA_PROBE_BASIC_STREAM";
pub const ANCHOR_TOOL_USE_STREAM: &str = "STRAVIA_PROBE_TOOL_USE_STREAM";
pub const ANCHOR_REASONING_STREAM: &str = "STRAVIA_PROBE_REASONING_STREAM";
...
pub struct ScenarioBodies {
    ...
    pub open_responses: Option<&'static str>,
...
pub struct ScenarioExpectedFields {
    ...
    pub open_responses: &'static [&'static str],
...
const OPENAI_CHAT_BASIC_NONSTREAM: &str = r#"{
  ...
  "stream": false,
  "messages": [
    {"role": "user", "content": "Reply with the literal token STRAVIA_PROBE_BASIC_NONSTREAM and nothing else."}
  ]
}"#;

const OPEN_RESPONSES_BASIC_NONSTREAM: &str = r#"{
  "model": "{{MODEL}}",
  "stream": false,
  "input": "Reply with the literal token STRAVIA_PROBE_BASIC_NONSTREAM and nothing else."
}"#;
...
const GOOGLE_BASIC_NONSTREAM: &str = r#"{
  "contents": [
    {"role": "user", "parts": [{"text": "Reply with the literal token STRAVIA_PROBE_BASIC_NONSTREAM and nothing else."}]}
  ]
}"#;
...
const OPENAI_CHAT_BASIC_STREAM: &str = r#"{
  ...
  "stream": true,
  "messages": [
    {"role": "user", "content": "Reply with the literal token STRAVIA_PROBE_BASIC_STREAM and nothing else."}
  ]
}"#;

const OPEN_RESPONSES_BASIC_STREAM: &str = r#"{
  "model": "{{MODEL}}",
  "stream": true,
  "input": "Reply with the literal token STRAVIA_PROBE_BASIC_STREAM and nothing else."
}"#;
...
const GOOGLE_BASIC_STREAM: &str = r#"{
  "contents": [
    {"role": "user", "parts": [{"text": "Reply with the literal token STRAVIA_PROBE_BASIC_STREAM and nothing else."}]}
  ]
}"#;
...
const OPENAI_CHAT_TOOL_USE_STREAM: &str = r#"{
  ...
  "stream": true,
  "messages": [
    {"role": "user", "content": "Probe STRAVIA_PROBE_TOOL_USE_STREAM. Use the get_current_weather tool to find the weather in Tokyo."}
  ],
  "tools": [
    {
      "type": "function",
...
const OPEN_RESPONSES_TOOL_USE_STREAM: &str = r#"{
  "model": "{{MODEL}}",
  "stream": true,
  "input": "Probe STRAVIA_PROBE_TOOL_USE_STREAM. Use the get_current_weather tool to find the weather in Tokyo.",
  "tools": [
    {
      "type": "function",
      "name": "get_current_weather",
...
const GOOGLE_TOOL_USE_STREAM: &str = r#"{
  "contents": [
    {"role": "user", "parts": [{"text": "Probe STRAVIA_PROBE_TOOL_USE_STREAM. Use the get_current_weather tool to find the weather in Tokyo."}]}
  ],
  "tools": [
    {
...
const OPENAI_CHAT_REASONING_STREAM: &str = r#"{
  ...
  "messages": [
    {"role": "user", "content": "Solve step by step then say STRAVIA_PROBE_REASONING_STREAM as the final line: what is 17 times 23?"}
  ]
}"#;

const OPEN_RESPONSES_REASONING_STREAM: &str = r#"{
  "model": "{{MODEL}}",
  "stream": true,
  "reasoning": {"effort": "low"},
  "input": "Solve step by step then say STRAVIA_PROBE_REASONING_STREAM as the final line: what is 17 times 23?"
}"#;
...
const GOOGLE_REASONING_STREAM: &str = r#"{
  "contents": [
    {"role": "user", "parts": [{"text": "Solve step by step then say STRAVIA_PROBE_REASONING_STREAM as the final line: what is 17 times 23?"}]}
  ],
  "generationConfig": {
...
pub const SCENARIOS: &[Scenario] = &[
    Scenario {
        ...
        bodies: ScenarioBodies {
            ...
            open_responses: Some(OPEN_RESPONSES_BASIC_NONSTREAM),
    ...
    Scenario {
        ...
        bodies: ScenarioBodies {
            ...
            open_responses: Some(OPEN_RESPONSES_TOOL_USE_STREAM),
    ...
    Scenario {
        ...
        bodies: ScenarioBodies {
            ...
            open_responses: Some(OPEN_RESPONSES_REASONING_STREAM),
...
impl Scenario {
    pub fn body_for(&self, protocol: crate::protocol::ProtocolKind) -> Option<&'static str> {
        ...
        match protocol {
            ...
            OpenResponses => self.bodies.open_responses,
    ...
    pub fn expected_fields_for(
        ...
        match protocol {
            ...
            OpenResponses => self.expected_fields.open_responses,
