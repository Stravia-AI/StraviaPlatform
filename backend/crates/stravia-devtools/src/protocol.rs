...
impl ProtocolKind {
    ...
    pub fn ingress_path_template(self) -> &'static str {
        match self {
            ...
            ProtocolKind::OpenResponses => "/v1/responses",
    ...
    pub fn record_path_suffix(self, stream: bool, real_model: &str) -> (String, Option<String>) {
        match self {
            ...
            ProtocolKind::OpenResponses => ("/responses".to_string(), None),
...
impl FromStr for ProtocolKind {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "open-responses" => Ok(ProtocolKind::OpenResponses),
...
mod tests {
    ...
    fn record_suffix_openai_family() {
        ...
        let (path, q) = ProtocolKind::OpenResponses.record_path_suffix(false, "gpt-4o");
