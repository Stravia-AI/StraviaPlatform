...
use crate::protocol::ir::{
    AiItem, AiRequest, AiResponse, EmbeddingInput, GenerationConfig, ProtocolExt, ToolCall,
    ToolChoice, ToolSpec,
};
...
impl HookDescriptor {
    ...
    pub fn accepts(&self, request_kind: RequestKind, event_kind: EventKind) -> bool {
...
pub struct ResponseHookOutcome {
