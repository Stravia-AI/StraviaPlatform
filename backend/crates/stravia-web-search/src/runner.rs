...
#[async_trait]
pub trait SearchRunAuthorizer: Send + Sync {
    async fn authorize(
        &self,
        principal: &Principal,
...
fn decode_ancestors(
    nodes: &[stravia_runtime_contract::turn_chain::TurnNode],
