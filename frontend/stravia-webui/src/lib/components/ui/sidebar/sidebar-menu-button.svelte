...
export const sidebarMenuButtonVariants = tv({
  ...
  variants: {
    ...
    size: { default: 'h-10 text-sm', sm: 'h-7 text-xs', lg: 'h-12 text-sm group-data-[collapsible=icon]:p-0!' },
  },
